...

{
    ...
    public function index()
    {
        ...
        $data["list_harga"] = $this->hrg->getAllHarga()->result_array();
    ...
    public function add_harga()
    {
        ...
        $data['jns_harga'] = $this->jns_hrg->getAllJns_harga()->result();
    ...
    public function add_harga_proses()
    {
        ...
        $is_duplicate = $this->hrg->cek_duplikasi_harga($perumahan[0], $rumah[0], $jenis_harga[0]);
        ...
        if (!$is_duplicate) {
            $data_rumah = array(
                ...
                'id_rumah'     => $rumah[0],
                'norumah'     => strtoupper($rumah[1]),
                'id_jns'    => $jenis_harga[0],
                'nama_harga'    => $jenis_harga[1],
                'nominal'   => $this->input->post('nominal'),
                'terbayar'   => 0,
                'sisa'   => 0
            );

            $insert = $this->hrg->addharga($data_rumah);
            // hrg_rmh
    ...
    // public function cek_detail_getAllRumah()
    // {
    //     $id_perumahan = $this->input->post('id_perumahan');
    //     $data["homes"] = $this->rmh->get_rumah_by_perum_id($id_perumahan)->result_array();

    //     // $data = "";
    //     $this->load->view('admin/rumah_list_cek_harga_showhomes', $data);
    // }
