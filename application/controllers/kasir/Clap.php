 ...
 */
class Clap extends MY_Kasir_Controller

{
    ...
    {
        parent::__construct();
        $this->load->model('M_do_trx_do', 'trxdo'); // <-- baris penting ini
    ...
    public function trx_open_DO()
    {
        // echo "tes Home";
        // return;
        // $data['menus'] = $this->Menu_model->get_all();
        $data['judul'] = "Laporan Pembukaan DO";
        // $this->M_material->getAllMaterials();
        $this->load->view('kasir/lap_open_DO', $data);
    }

    public function trx_open_DO_view()
    {
        // echo "tes Home";
        $tgl_awal = str_replace("-", "", $this->input->post("tgl_awal"));
        // $tgl_awal = $this->input->post("tgl_awal"); // str_replace($this->input->post("tgl_awal"), "-", "");
        ...
        $data['dataDO'] =  $this->trxdo->getDoOpenPerPeriode($tgl_awal, $tgl_akhir)->result_array();
        // $this->M_material->getAllMaterials();
        $this->load->view('kasir/lap_open_DO_view', $data);
    }


    public function lap_sisa_DO_allBar()
    {
        ...
        $data['dataDO'] =  $this->trxdo->getsisaDO_allbar()->result_array();
        // $this->M_material->getAllMaterials();
        $this->load->view('kasir/lap_sisa_DO_allbar', $data);
    }
