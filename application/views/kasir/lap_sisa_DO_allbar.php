                ...
                <div class="container-fluid p-2">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">LAPORAN SISA DO SEMUA BARANG </h6>
                        </div>
                                ...
                                <table class="table table-striped table-hover table-bordered" id="laporanPenjualanKeluar">
                                    <thead class="table-primary">
                                        <tr>
                                            ...
                                            <th>Tanggal Trx </th>
                                            <th>Barang </th>
                                            <th>Qty Open <br> Harga Open </th>
                                            <th>Qty Keluar </th>
                                            <th>Qty Sisa </th>
                                            <th>Total Harga Sisa </th>
                                            <th>Subtotal </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <?php else : ?>
                                            <tr>
                                                <td colspan="9" class="text-center text-muted">Tidak ada data DO </td>
                                            </tr>
                                        <?php endif; ?>
                                    </tbody>
